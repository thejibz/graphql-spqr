...
public class AnnotatedResolverBuilder extends PublicResolverBuilder {
    ...
    protected boolean isQuery(Method method, ResolverBuilderParams params) {
        return method.isAnnotationPresent(GraphQLQuery.class) || method.isAnnotationPresent(Query.class);
    }

    @Override
    protected boolean isQuery(Field field, ResolverBuilderParams params) {
        return field.isAnnotationPresent(GraphQLQuery.class) || field.isAnnotationPresent(Query.class);
    }
    ...
    protected boolean isMutation(Method method, ResolverBuilderParams params) {
        return method.isAnnotationPresent(GraphQLMutation.class) || method.isAnnotationPresent(Mutation.class);
    }
    ...
    private static TypedElement annotatedElementReducer(TypedElement field, TypedElement getter) {
        ...
        return field.isAnnotationPresent(GraphQLQuery.class) || field.isAnnotationPresent(Query.class) ? field : getter;
    }
}
